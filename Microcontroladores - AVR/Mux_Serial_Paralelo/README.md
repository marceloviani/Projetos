...
Outro ponto visto foi o entendimento do CI 4094, sendo utilizada uma função que “setava” os dígitos para o display, e depois sendo acionado o strobe para completar o envio para o display.
